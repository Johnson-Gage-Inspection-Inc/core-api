...
class AssetServiceRecordQuerySchema(Schema):
    assetId = fields.Str(required=True, metadata={"description": "The ID of the asset to retrieve service records for"})
        ...
        **Response**: Array of asset service record objects for the specified asset
        ...
        try:
            ...
            if hasattr(e, 'status') and e.status == 404:
                abort(404, message=f"Asset with ID '{assetId}' not found or has no service records")
            else:
