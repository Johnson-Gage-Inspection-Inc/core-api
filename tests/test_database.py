...
class TestDatabaseModels:
    ...
    def test_daqbook_offset_model_creation(self):
        ...
        offset = DaqbookOffset(tn="TEST123", temp=25.5, point=1, reading=0.001)
    ...
    def test_daqbook_offset_delta_property(self):
        ...
        offset = DaqbookOffset(tn="TEST123", temp=25.0, point=1, reading=25.5)
        ...
        offset2 = DaqbookOffset(tn="TEST456", temp=100.0, point=2, reading=99.8)
        ...
        offset3 = DaqbookOffset(tn="TEST789", temp=0.0, point=3, reading=0.123456)
