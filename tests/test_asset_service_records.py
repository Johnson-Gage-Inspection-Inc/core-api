...
from qualer_sdk.models import QualerApiModelsAssetServiceRecordsToAssetServiceRecordResponseModel
...
def test_asset_service_record_endpoint_mocked(mock_qualer_client, mock_asset_service_records_api_class, client, auth_token):
    ...
    mock_asset_service_record1 = MagicMock(QualerApiModelsAssetServiceRecordsToAssetServiceRecordResponseModel)
    ...
    mock_asset_service_record2 = MagicMock(QualerApiModelsAssetServiceRecordsToAssetServiceRecordResponseModel)
    ...
    mock_asset_service_records = [mock_asset_service_record1, mock_asset_service_record2]
    
    mock_asset_service_records_api = MagicMock()
    mock_asset_service_records_api.get_asset_service_records_by_asset.return_value = mock_asset_service_records
...
@patch('routes.asset_service_records.AssetServiceRecordsApi')
@patch('utils.qualer_client.make_qualer_client')
def test_asset_service_record_endpoint_not_found(mock_qualer_client, mock_asset_service_records_api_class, client, auth_token):
    ...
    if os.getenv("SKIP_AUTH", "false").lower() == "true":
        ...
        mock_asset_service_records_api.get_asset_service_records_by_asset.side_effect = mock_exception
        mock_asset_service_records_api_class.return_value = mock_asset_service_records_api
...
@patch('routes.asset_service_records.AssetServiceRecordsApi')
@patch('utils.qualer_client.make_qualer_client')
def test_asset_service_record_endpoint_api_error(mock_qualer_client, mock_asset_service_records_api_class, client, auth_token):
    ...
    if os.getenv("SKIP_AUTH", "false").lower() == "true":
        ...
        mock_function = app.view_functions.get("asset-service-records.AssetServiceRecord")
        
        try:
            # Restore real view function for this test
            asset_service_record_view = AssetServiceRecord()
            app.view_functions["asset-service-records.AssetServiceRecord"] = asset_service_record_view.get
            
            # Now the SDK patches will work
            mock_asset_service_records_api = MagicMock()
            mock_asset_service_records_api.get_asset_service_records_by_asset.side_effect = Exception("Qualer API Error")
            mock_asset_service_records_api_class.return_value = mock_asset_service_records_api
            ...
            if mock_function:
                app.view_functions["asset-service-records.AssetServiceRecord"] = mock_function
    else:
        # Normal testing mode
        mock_asset_service_records_api = MagicMock()
        mock_asset_service_records_api.get_asset_service_records_by_asset.side_effect = Exception("Qualer API Error")
