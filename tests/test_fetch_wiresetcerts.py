...
class TestFetchWiresetcerts:
    ...
    def test_main_success_with_multiple_sheets(self, capsys):
        ...
        with patch(
            "utils.fetch_wiresetcerts.get_wiresetcerts_content"
        ) as mock_get_content:
        ...
        mock_data = {
            ...
            "sheets": {
                "Sheet1": {
                    ...
                    "sample_data": [["A", "B", "C", "D", "E", "F", "G", "H", "I", "J"]],
                }
            },
        }
        ...
        mock_data = {
            ...
            "sheets": {
                "Sheet1": {
                    ...
                    "sample_data": [["Data", None, "MoreData"], [None, "Value", None]],
                }
            },
        }
            ...
            "sheets": {
                "Sheet1": {
                    ...
                    "sample_data": [
                        [
                            "OK",
                            "This is a very long value that should be truncated at 20 characters",
                        ]
                    ],
                }
            },
    ...
    @pytest.mark.parametrize(
        "sheet_count,expected_plural",
        [(0, "sheet(s)"), (1, "sheet(s)"), (2, "sheet(s)"), (5, "sheet(s)")],
    )
