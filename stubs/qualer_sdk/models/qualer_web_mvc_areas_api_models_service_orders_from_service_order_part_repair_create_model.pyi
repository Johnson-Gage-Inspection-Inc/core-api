...
class QualerWebMvcAreasApiModelsServiceOrdersFromServiceOrderPartRepairCreateModel(BaseModel):
    name: StrictStr | None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QualerWebMvcAreasApiModelsServiceOrdersFromServiceOrderPartRepairCreateModel: ...
    def to_dict(self): ...
    @classmethod
    def from_dict(cls, obj: dict) -> QualerWebMvcAreasApiModelsServiceOrdersFromServiceOrderPartRepairCreateModel: ...
