...
class QualerApiModelsReportDatasetsToAssetSummaryResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QualerApiModelsReportDatasetsToAssetSummaryResponse: ...
    def to_dict(self): ...
    @classmethod
    def from_dict(cls, obj: dict) -> QualerApiModelsReportDatasetsToAssetSummaryResponse: ...
