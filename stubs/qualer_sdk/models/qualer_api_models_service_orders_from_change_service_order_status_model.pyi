...
class QualerApiModelsServiceOrdersFromChangeServiceOrderStatusModel(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QualerApiModelsServiceOrdersFromChangeServiceOrderStatusModel: ...
    def to_dict(self): ...
    @classmethod
    def from_dict(cls, obj: dict) -> QualerApiModelsServiceOrdersFromChangeServiceOrderStatusModel: ...
