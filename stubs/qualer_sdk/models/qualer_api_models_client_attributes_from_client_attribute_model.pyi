...
class QualerApiModelsClientAttributesFromClientAttributeModel(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QualerApiModelsClientAttributesFromClientAttributeModel: ...
    def to_dict(self): ...
    @classmethod
    def from_dict(cls, obj: dict) -> QualerApiModelsClientAttributesFromClientAttributeModel: ...
