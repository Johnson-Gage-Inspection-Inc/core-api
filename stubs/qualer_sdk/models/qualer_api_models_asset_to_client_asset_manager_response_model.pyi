...
class QualerApiModelsAssetToClientAssetManagerResponseModel(BaseModel):
    ...
    asset_collection_id: StrictInt | None
    ...
    in_last_service: StrictBool | None
    ...
    service_tag: StrictStr | None
    service_site_name: StrictStr | None
    service_site_id: StrictInt | None
    standard_title: StrictStr | None
    schedules: StrictStr | None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QualerApiModelsAssetToClientAssetManagerResponseModel: ...
    def to_dict(self): ...
    @classmethod
    def from_dict(cls, obj: dict) -> QualerApiModelsAssetToClientAssetManagerResponseModel: ...
