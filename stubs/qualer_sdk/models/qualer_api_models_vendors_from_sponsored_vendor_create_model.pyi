...
class QualerApiModelsVendorsFromSponsoredVendorCreateModel(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QualerApiModelsVendorsFromSponsoredVendorCreateModel: ...
    def to_dict(self): ...
    @classmethod
    def from_dict(cls, obj: dict) -> QualerApiModelsVendorsFromSponsoredVendorCreateModel: ...
