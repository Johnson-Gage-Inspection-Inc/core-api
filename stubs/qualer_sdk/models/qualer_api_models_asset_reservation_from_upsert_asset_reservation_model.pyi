...
class QualerApiModelsAssetReservationFromUpsertAssetReservationModel(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QualerApiModelsAssetReservationFromUpsertAssetReservationModel: ...
    def to_dict(self): ...
    @classmethod
    def from_dict(cls, obj: dict) -> QualerApiModelsAssetReservationFromUpsertAssetReservationModel: ...
