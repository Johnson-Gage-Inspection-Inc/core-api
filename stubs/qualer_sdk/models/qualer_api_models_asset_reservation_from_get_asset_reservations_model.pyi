...
class QualerApiModelsAssetReservationFromGetAssetReservationsModel(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QualerApiModelsAssetReservationFromGetAssetReservationsModel: ...
    def to_dict(self): ...
    @classmethod
    def from_dict(cls, obj: dict) -> QualerApiModelsAssetReservationFromGetAssetReservationsModel: ...
