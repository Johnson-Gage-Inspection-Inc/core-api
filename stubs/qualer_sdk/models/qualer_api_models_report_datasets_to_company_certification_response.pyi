...
from pydantic import BaseModel, StrictStr as StrictStr, conbytes as conbytes, constr as constr
...
class QualerApiModelsReportDatasetsToCompanyCertificationResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QualerApiModelsReportDatasetsToCompanyCertificationResponse: ...
    def to_dict(self): ...
    @classmethod
    def from_dict(cls, obj: dict) -> QualerApiModelsReportDatasetsToCompanyCertificationResponse: ...
