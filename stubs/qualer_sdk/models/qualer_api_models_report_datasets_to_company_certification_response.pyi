...
class QualerApiModelsReportDatasetsToCompanyCertificationResponse:
    logo: Unset | str = ...
    initial_date: Unset | datetime.datetime = ...
    certification_date: Unset | datetime.datetime = ...
    expiration_date: Unset | datetime.datetime = ...
    certification_name: Unset | str = ...
    certificate_number: Unset | str = ...
    certification_authority: Unset | str = ...
    certification_standard: Unset | str = ...
