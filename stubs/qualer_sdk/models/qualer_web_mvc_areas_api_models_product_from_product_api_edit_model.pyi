...
class QualerWebMvcAreasApiModelsProductFromProductApiEditModel(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QualerWebMvcAreasApiModelsProductFromProductApiEditModel: ...
    def to_dict(self): ...
    @classmethod
    def from_dict(cls, obj: dict) -> QualerWebMvcAreasApiModelsProductFromProductApiEditModel: ...
