...
class QualerApiModelsServiceOrdersFromServiceOrderTaskCreateModel(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QualerApiModelsServiceOrdersFromServiceOrderTaskCreateModel: ...
    def to_dict(self): ...
    @classmethod
    def from_dict(cls, obj: dict) -> QualerApiModelsServiceOrdersFromServiceOrderTaskCreateModel: ...
