...
class QualerApiModelsServiceOrdersFromServiceOrderTaskUpdateModel(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QualerApiModelsServiceOrdersFromServiceOrderTaskUpdateModel: ...
    def to_dict(self): ...
    @classmethod
    def from_dict(cls, obj: dict) -> QualerApiModelsServiceOrdersFromServiceOrderTaskUpdateModel: ...
