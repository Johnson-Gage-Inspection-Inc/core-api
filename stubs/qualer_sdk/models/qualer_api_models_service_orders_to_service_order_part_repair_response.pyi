...
class QualerApiModelsServiceOrdersToServiceOrderPartRepairResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QualerApiModelsServiceOrdersToServiceOrderPartRepairResponse: ...
    def to_dict(self): ...
    @classmethod
    def from_dict(cls, obj: dict) -> QualerApiModelsServiceOrdersToServiceOrderPartRepairResponse: ...
