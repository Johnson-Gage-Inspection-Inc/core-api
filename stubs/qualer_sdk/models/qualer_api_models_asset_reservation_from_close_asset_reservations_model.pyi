...
class QualerApiModelsAssetReservationFromCloseAssetReservationsModel(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QualerApiModelsAssetReservationFromCloseAssetReservationsModel: ...
    def to_dict(self): ...
    @classmethod
    def from_dict(cls, obj: dict) -> QualerApiModelsAssetReservationFromCloseAssetReservationsModel: ...
