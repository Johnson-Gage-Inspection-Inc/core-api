...
class QualerApiModelsReportDatasetsToMeasurementChannelUniformityResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QualerApiModelsReportDatasetsToMeasurementChannelUniformityResponse: ...
    def to_dict(self): ...
    @classmethod
    def from_dict(cls, obj: dict) -> QualerApiModelsReportDatasetsToMeasurementChannelUniformityResponse: ...
