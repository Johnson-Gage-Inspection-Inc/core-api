...
class QualerApiModelsAssetToClientAssetCountersResponseModel:
    client_assets_collected: Unset | int = ...
    client_unset: Unset | int = ...
    client_due_for_service: Unset | int = ...
    client_past_due: Unset | int = ...
    client_out_of_service: Unset | int = ...
    client_without_schedule: Unset | int = ...
