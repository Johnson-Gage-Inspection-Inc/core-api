...
class QualerApiModelsAssetServiceRecordsFromUpdateAssetServiceRecordModel(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QualerApiModelsAssetServiceRecordsFromUpdateAssetServiceRecordModel: ...
    def to_dict(self): ...
    @classmethod
    def from_dict(cls, obj: dict) -> QualerApiModelsAssetServiceRecordsFromUpdateAssetServiceRecordModel: ...
