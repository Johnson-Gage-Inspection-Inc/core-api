...
class ClientsApi:
    ...
    def create(
        self,
        model: Annotated[QualerApiModelsClientsFromSponsoredClientCreateModel, None],
        **kwargs,
    ...
    def get_all_get2(
        self,
        model_legacy_id: StrictStr | None = None,
    ...
    def update(
        self,
        model: Annotated[QualerApiModelsClientsFromSponsoredClientEditModel, None],
        **kwargs,
    ) -> object: ...
    @validate_arguments
