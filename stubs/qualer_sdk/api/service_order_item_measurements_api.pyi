...
class ServiceOrderItemMeasurementsApi:
    ...
    def add_auxiliary_tools(
        self, work_item_id: StrictInt, models: None, **kwargs
    ) -> object: ...
    @validate_arguments
    ...
    def create_measurement_form(
        self,
        work_item_id: Annotated[StrictInt, None],
        model: Annotated[
            QualerApiModelsMeasurementsFromCreateMeasurementFormModel, None
        ],
        **kwargs,
    ) -> object: ...
    @validate_arguments
    ...
    def get_measurement_form(
        self, work_item_id: Annotated[StrictInt, None], **kwargs
    ...
    def update_measurement_form(
        ...
        work_item_id: Annotated[StrictInt, None],
        model: Annotated[
            QualerApiModelsMeasurementsFromUpdateMeasurementFormModel, None
        ],
        **kwargs,
    ) -> object: ...
    @validate_arguments
