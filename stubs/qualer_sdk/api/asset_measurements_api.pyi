...
class AssetMeasurementsApi:
    ...
    @validate_arguments
    def get_measurements_by_asset(self, asset_id: StrictInt, var_from: datetime | None = None, to: datetime | None = None, **kwargs) -> list[QualerApiModelsMeasurementsToMeasurementRecordResponseModel]: ...
    @validate_arguments
    def get_measurements_by_asset_with_http_info(self, asset_id: StrictInt, var_from: datetime | None = None, to: datetime | None = None, **kwargs) -> ApiResponse: ...
