...
class ClientSiteApi:
    ...
    def create_client_site(
        self,
        client_company_id: Annotated[StrictInt, None],
        model: Annotated[QualerApiModelsSiteFromSiteCreateModel, None],
        **kwargs,
    ) -> object: ...
    @validate_arguments
    ...
    def update_client_site(
        self,
        client_company_id: Annotated[StrictInt, None],
        model: Annotated[QualerApiModelsSiteFromSiteUpdateModel, None],
        **kwargs,
    ) -> object: ...
    @validate_arguments
