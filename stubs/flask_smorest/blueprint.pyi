...
from .utils import deepupdate as deepupdate, load_info_from_docstring as load_info_from_docstring
...
class Blueprint(FlaskBlueprint, ArgumentsMixin, ResponseMixin, PaginationMixin, EtagMixin):
    ...
    def add_url_rule(self, rule, endpoint: Incomplete | None = None, view_func: Incomplete | None = None, provide_automatic_options: Incomplete | None = None, *, parameters: Incomplete | None = None, tags: Incomplete | None = None, **options) -> None: ...
    def route(self, rule, *, parameters: Incomplete | None = None, tags: Incomplete | None = None, **options): ...
