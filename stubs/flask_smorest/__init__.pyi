...
class Api(APISpecMixin, ErrorHandlerMixin):
    ...
    config: Incomplete
    spec: Incomplete
    def __init__(self, app: Incomplete | None = None, *, spec_kwargs: Incomplete | None = None, config_prefix: str = '') -> None: ...
    def init_app(self, app, *, spec_kwargs: Incomplete | None = None) -> None: ...
    def register_blueprint(self, blp, *, parameters: Incomplete | None = None, **options) -> None: ...
