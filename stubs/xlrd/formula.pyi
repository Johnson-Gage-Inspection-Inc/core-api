...
class Operand:
    ...
    def __init__(
        self,
        akind: Incomplete | None = None,
        avalue: Incomplete | None = None,
        arank: int = 0,
        atext: str = "?",
    ) -> None: ...
...
def decompile_formula(
    ...
    fmla,
    fmlalen,
    fmlatype: Incomplete | None = None,
    browx: Incomplete | None = None,
    bcolx: Incomplete | None = None,
    blah: int = 0,
    level: int = 0,
    r1c1: int = 0,
): ...
def dump_formula(
    bk, data, fmlalen, bv, reldelta, blah: int = 0, isname: int = 0
) -> None: ...
