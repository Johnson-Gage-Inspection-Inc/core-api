...
class Sheet(BaseObject):
    ...
    __iter__ = get_rows
    def row_types(
        self, rowx, start_colx: int = 0, end_colx: Incomplete | None = None
    ): ...
    def row_values(
        self, rowx, start_colx: int = 0, end_colx: Incomplete | None = None
    ): ...
    ...
    def col_slice(
        self, colx, start_rowx: int = 0, end_rowx: Incomplete | None = None
    ): ...
    def col_values(
        self, colx, start_rowx: int = 0, end_rowx: Incomplete | None = None
    ): ...
    ...
    def fixed_BIFF2_xfindex(
        self, cell_attr, rowx, colx, true_xfx: Incomplete | None = None
    ): ...
