...
class BaseObject:
    def dump(self, f: Incomplete | None = None, header: Incomplete | None = None, footer: Incomplete | None = None, indent: int = 0) -> None: ...
...
def unpack_string_update_pos(data, pos, encoding, lenlen: int = 1, known_len: Incomplete | None = None): ...
def unpack_unicode(data, pos, lenlen: int = 2): ...
def unpack_unicode_update_pos(data, pos, lenlen: int = 2, known_len: Incomplete | None = None): ...
def unpack_cell_range_address_list_update_pos(output_list, data, pos, biff_version, addr_size: int = 6): ...

biff_rec_name_dict: Incomplete

def hex_char_dump(strg, ofs, dlen, base: int = 0, fout=..., unnumbered: bool = False) -> None: ...
def biff_dump(mem, stream_offset, stream_len, base: int = 0, fout=..., unnumbered: bool = False) -> None: ...
