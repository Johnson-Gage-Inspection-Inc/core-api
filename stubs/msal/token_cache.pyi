...
class TokenCache:
    ...
    def search(self, credential_type, target: Incomplete | None = None, query: Incomplete | None = None, *, now: Incomplete | None = None) -> Generator[Incomplete]: ...
    def find(self, credential_type, target: Incomplete | None = None, query: Incomplete | None = None, *, now: Incomplete | None = None): ...
