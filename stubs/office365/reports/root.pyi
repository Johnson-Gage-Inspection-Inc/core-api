...
from office365.directory.authentication.methods.root import (
    AuthenticationMethodsRoot as AuthenticationMethodsRoot,
)
...
from office365.reports.internal.queries.create_report_query import (
    create_report_query as create_report_query,
)
...
class ReportRoot(Entity):
    ...
    def managed_device_enrollment_top_failures(
        self, period: Incomplete | None = None
    ): ...
