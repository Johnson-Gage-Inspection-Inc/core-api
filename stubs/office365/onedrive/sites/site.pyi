...
from office365.onedrive.columns.definition_collection import ColumnDefinitionCollection as ColumnDefinitionCollection
from office365.onedrive.contenttypes.collection import ContentTypeCollection as ContentTypeCollection
...
from office365.onedrive.operations.rich_long_running import RichLongRunningOperation as RichLongRunningOperation
...
from office365.onedrive.sitepages.collection import SitePageCollection as SitePageCollection
...
class Site(BaseItem):
    ...
    def get_applicable_content_types_for_list(self, list_id: str) -> ContentTypeCollection: ...
    def get_activities_by_interval(self, start_dt: datetime | None = None, end_dt: datetime | None = None, interval: str = None) -> EntityCollection[ItemActivityStat]: ...
    @property
