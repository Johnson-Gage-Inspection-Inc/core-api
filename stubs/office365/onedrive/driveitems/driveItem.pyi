...
from office365.onedrive.driveitems.conflict_behavior import ConflictBehavior as ConflictBehavior
...
from office365.onedrive.driveitems.item_preview_info import ItemPreviewInfo as ItemPreviewInfo
...
from office365.onedrive.driveitems.retention_label import ItemRetentionLabel as ItemRetentionLabel
...
from office365.onedrive.driveitems.uploadable_properties import DriveItemUploadableProperties as DriveItemUploadableProperties
...
from office365.onedrive.permissions.collection import PermissionCollection as PermissionCollection
from office365.onedrive.permissions.permission import Permission as Permission
from office365.onedrive.sensitivitylabels.extract_result import ExtractSensitivityLabelsResult as ExtractSensitivityLabelsResult
...
class DriveItem(BaseItem):
    ...
    def create_link(self, link_type: str, scope: str | None = None, expiration_datetime: datetime | None = None, password: str | None = None, message: str | None = None, retain_inherited_permissions: bool | None = None) -> Permission: ...
    def discard_checkout(self): ...
    def extract_sensitivity_labels(self) -> ClientResult[ExtractSensitivityLabelsResult]: ...
    ...
    def resumable_upload(self, source_path: str, chunk_size: int = 2000000, chunk_uploaded: Callable[[int], None] | None = None) -> DriveItem: ...
    ...
    def download_folder(self, download_file: IO, after_file_downloaded: Callable[[DriveItem], None] = None, recursive: bool = True) -> DriveItem: ...
    def download_session(self, file_object: IO, chunk_downloaded: None = None, chunk_size: int | None = ...) -> Self: ...
    def create_folder(self, name: str, conflict_behavior: ConflictBehavior | None = ...) -> DriveItem: ...
    def convert(self, format_name: str) -> ClientResult[AnyStr]: ...
    def copy(self, name: str = None, parent: ItemReference | DriveItem = None, conflict_behavior: str = ...) -> ClientResult[str]: ...
    def move(self, name: str = None, parent: ItemReference | DriveItem = None, conflict_behavior: str = ...) -> DriveItem: ...
    def rename(self, new_name: str) -> DriveItem: ...
    def search(self, query_text: str) -> EntityCollection['DriveItem']: ...
    def invite(self, recipients: list[str], message: str, require_sign_in: bool | None = True, send_invitation: bool | None = True, roles: list[str] | None = None, expiration_datetime: datetime | None = None, password: str | None = None, retain_inherited_permissions: bool | None = None) -> PermissionCollection: ...
    def get_activities_by_interval(self, start_dt: Incomplete | None = None, end_dt: Incomplete | None = None, interval: Incomplete | None = None): ...
    def permanent_delete(self): ...
    def restore(self, parent_reference: ItemReference | None = None, name: str = None) -> DriveItem: ...
    def preview(self, page: None, zoom: None = None) -> ClientResult[ItemPreviewInfo]: ...
