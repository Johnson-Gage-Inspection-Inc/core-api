...
class ColumnDefinitionCollection(EntityCollection[ColumnDefinition]):
    ...
    def add_number(self, name, minimum: Incomplete | None = None, maximum: Incomplete | None = None): ...
    def add_text(self, name, max_length: Incomplete | None = None, text_type: Incomplete | None = None): ...
    def add_hyperlink_or_picture(self, name, is_picture: Incomplete | None = None): ...
    def add_lookup(self, name: str, lookup_list: List | str, column_name: str | None = None) -> ColumnDefinition: ...
