...
from office365.runtime.auth.providers.acs_token_provider import ACSTokenProvider as ACSTokenProvider
from office365.runtime.auth.providers.saml_token_provider import SamlTokenProvider as SamlTokenProvider
...
class AuthenticationContext:
    url: Incomplete
    def __init__(self, url, environment: Incomplete | None = None, allow_ntlm: bool = False, browser_mode: bool = False) -> None: ...
    def with_client_certificate(self, tenant, client_id, thumbprint, cert_path: Incomplete | None = None, private_key: Incomplete | None = None, scopes: Incomplete | None = None, passphrase: Incomplete | None = None): ...
    ...
    def with_credentials(self, credentials: UserCredential | ClientCredential) -> AuthenticationContext: ...
