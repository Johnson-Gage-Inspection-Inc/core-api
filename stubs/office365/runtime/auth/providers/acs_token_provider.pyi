...
class ACSTokenProvider(AuthenticationProvider, office365.logger.LoggerContext):
    ...
    def __init__(self, url, client_id, client_secret, environment: Incomplete | None = None) -> None: ...
    def authenticate_request(self, request: RequestOptions) -> None: ...
    def get_app_only_access_token(self): ...
    @staticmethod
    def get_formatted_principal(principal_name: str, host_name: str | None, realm: str) -> str: ...
