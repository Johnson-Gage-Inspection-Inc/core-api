...
class ClientObjectCollection(ClientObject, Generic[T]):
    def __init__(self, context: ClientRuntimeContext, item_type: type[T], resource_path: ResourcePath | None = None, parent: ClientObject | None = None) -> None: ...
    def clear_state(self): ...
    def create_typed_object(self, initial_properties: dict | None = None, resource_path: ResourcePath | None = None) -> T: ...
    def set_property(self, key: str | int, value: dict, persist_changes: bool = False) -> Self: ...
    ...
    def paged(self, page_size: int = None, page_loaded: Callable[[Self], None] | None = None) -> Self: ...
    def get(self) -> Self: ...
    def get_all(self, page_size: int = None, page_loaded: Callable[[Self], None] | None = None) -> Self: ...
