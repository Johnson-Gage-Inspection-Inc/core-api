...
class ClientResult(Generic[T]):
    def __init__(self, context: ClientRuntimeContext, default_value: T | None = None) -> None: ...
    def before_execute(self, action: Callable[[RequestOptions], None]) -> Self: ...
    def after_execute(self, action: Callable[[Self], None], execute_first: bool = False, include_response: bool = False) -> Self: ...
    def set_property(self, key: str, value: T, persist_changes: bool = False) -> Self: ...
    @property
    def value(self): ...
