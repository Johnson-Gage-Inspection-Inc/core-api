...
class ClientQuery(Generic[T]):
    def __init__(self, context: ClientRuntimeContext, binding_type: ClientObject | None = None, parameters_type: ClientObject | ClientValue | dict | AnyStr | None = None, parameters_name: str | None = None, return_type: T | None = None) -> None: ...
