...
class ClientValueCollection(ClientValue, Generic[T]):
    def __init__(self, item_type: type[T], initial_values: list | dict | None = None) -> None: ...
    ...
    def set_property(self, index: str | int, value: Any, persist_changes: bool = False) -> Self: ...
    @property
