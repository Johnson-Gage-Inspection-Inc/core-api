...
class UploadSessionRequest(ClientRequest):
    def __init__(self, file_object: typing.IO, chunk_size: int, chunk_uploaded: Callable[[int], None] = None) -> None: ...
    def build_request(self, query: UploadSessionQuery) -> Self: ...
    def process_response(self, response: requests.Response, query: UploadSessionQuery) -> None: ...
