...
from office365.communications.cloud_communications import CloudCommunications as CloudCommunications
from office365.delta_collection import DeltaCollection as DeltaCollection
from office365.directory.applications.collection import ApplicationCollection as ApplicationCollection
from office365.directory.applications.template import ApplicationTemplate as ApplicationTemplate
from office365.directory.audit.log_root import AuditLogRoot as AuditLogRoot
from office365.directory.authentication.method_configuration import AuthenticationMethodConfiguration as AuthenticationMethodConfiguration
...
from office365.directory.groups.lifecycle_policy import GroupLifecyclePolicy as GroupLifecyclePolicy
from office365.directory.groups.setting_template import GroupSettingTemplate as GroupSettingTemplate
from office365.directory.identities.container import IdentityContainer as IdentityContainer
from office365.directory.identities.provider import IdentityProvider as IdentityProvider
from office365.directory.identitygovernance.governance import IdentityGovernance as IdentityGovernance
from office365.directory.internal.paths.me import MePath as MePath
from office365.directory.invitations.collection import InvitationCollection as InvitationCollection
...
from office365.directory.protection.information import InformationProtection as InformationProtection
from office365.directory.protection.root import IdentityProtectionRoot as IdentityProtectionRoot
from office365.directory.rolemanagement.management import RoleManagement as RoleManagement
...
from office365.directory.serviceprincipals.collection import ServicePrincipalCollection as ServicePrincipalCollection
from office365.directory.tenantinformation.relationship import TenantRelationship as TenantRelationship
...
from office365.intune.devices.app_management import DeviceAppManagement as DeviceAppManagement
from office365.intune.devices.collection import DeviceCollection as DeviceCollection
from office365.intune.devices.management.management import DeviceManagement as DeviceManagement
...
from office365.runtime.odata.v4.batch_request import ODataV4BatchRequest as ODataV4BatchRequest
...
from office365.subscriptions.collection import SubscriptionCollection as SubscriptionCollection
...
from office365.teams.viva.employee_experience import EmployeeExperience as EmployeeExperience
from typing import Any, Callable

class GraphClient(ClientRuntimeContext):
    def __init__(self, token_callback: Callable[[], dict] = None, tenant: str = None, scopes: list[str] = None, token_cache: Any = None, environment: str = ...) -> None: ...
    ...
    def with_token_interactive(self, client_id: str, username: str | None = None) -> GraphClient: ...
    def with_username_and_password(self, client_id: str, username: str, password: str) -> GraphClient: ...
    def execute_batch(self, items_per_batch: int = 20, success_callback: Incomplete | None = None): ...
