...
from office365.directory.authentication.authentication import Authentication as Authentication
from office365.directory.extensions.extension import Extension as Extension
from office365.directory.identities.object_identity import ObjectIdentity as ObjectIdentity
...
from office365.directory.insights.office_graph import OfficeGraphInsights as OfficeGraphInsights
from office365.directory.licenses.assigned_license import AssignedLicense as AssignedLicense
from office365.directory.licenses.assigned_plan import AssignedPlan as AssignedPlan
from office365.directory.licenses.assignment_state import LicenseAssignmentState as LicenseAssignmentState
...
from office365.directory.users.activities.collection import UserActivityCollection as UserActivityCollection
...
from office365.intune.devices.data import DeviceAndAppManagementData as DeviceAndAppManagementData
from office365.intune.devices.managed import ManagedDevice as ManagedDevice
from office365.intune.devices.managed_app_diagnostic_status import ManagedAppDiagnosticStatus as ManagedAppDiagnosticStatus
...
from office365.outlook.calendar.meetingtimes.suggestions_result import MeetingTimeSuggestionsResult as MeetingTimeSuggestionsResult
...
from office365.outlook.mail.folders.collection import MailFolderCollection as MailFolderCollection
...
from office365.teams.teamwork.shiftmanagement.user_solution_root import UserSolutionRoot as UserSolutionRoot
from office365.teams.teamwork.user import UserTeamwork as UserTeamwork
from office365.teams.viva.employee_experience_user import EmployeeExperienceUser as EmployeeExperienceUser
from office365.todo.todo import Todo as Todo
from typing_extensions import Self

class User(DirectoryObject):
    def enable_automatic_replies_setting(self, status: str, scheduled_start_datetime: datetime, scheduled_end_datetime: datetime, internal_reply_message: str = None, external_reply_message: str = None) -> Self: ...
    ...
    def get_mail_tips(self, email_addresses, mail_tips_options: Incomplete | None = None): ...
    def get_my_site(self): ...
    def send_mail(self, subject: str, body: str | ItemBody, to_recipients: list[str], cc_recipients: list[str] | None = None, bcc_recipients: list[str] | None = None, reply_to: list[str] | None = None, save_to_sent_items: bool = False, body_type: str = 'Text') -> Message: ...
    def export_personal_data(self, storage_location): ...
    def export_device_and_app_management_data(self): ...
    def find_meeting_times(self, attendees: Incomplete | None = None, location_constraint: Incomplete | None = None, time_constraint: Incomplete | None = None, meeting_duration: Incomplete | None = None, max_candidates: Incomplete | None = None, is_organizer_optional: Incomplete | None = None, return_suggestion_reasons: Incomplete | None = None, minimum_attendee_percentage: Incomplete | None = None): ...
    ...
    def translate_exchange_ids(self, input_ids, source_id_type: Incomplete | None = None, target_id_type: Incomplete | None = None): ...
    @property
