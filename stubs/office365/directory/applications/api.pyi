...
class ApiApplication(ClientValue):
    ...
    def __init__(self, accept_mapped_claims: Incomplete | None = None, known_client_applications: Incomplete | None = None, oauth2_permission_scopes: Incomplete | None = None) -> None: ...
