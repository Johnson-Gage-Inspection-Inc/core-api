...
from office365.directory.authentication.strength_usage import (
    AuthenticationStrengthUsage as AuthenticationStrengthUsage,
)
from office365.directory.policies.update_allowed_combinations_result import (
    UpdateAllowedCombinationsResult as UpdateAllowedCombinationsResult,
)
...
class AuthenticationStrengthPolicy(Entity):
    ...
    def update_allowed_combinations(
        self, allowed_combinations: Incomplete | None = None
    ): ...
