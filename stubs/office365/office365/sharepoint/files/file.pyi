...
from office365.sharepoint.activities.capabilities import (
    ActivityCapabilities as ActivityCapabilities,
)
from office365.sharepoint.entity import Entity as Entity
from office365.sharepoint.entity_collection import EntityCollection as EntityCollection
from office365.sharepoint.files.versions.collection import (
    FileVersionCollection as FileVersionCollection,
)
from office365.sharepoint.files.versions.event import (
    FileVersionEvent as FileVersionEvent,
)
...
from office365.sharepoint.permissions.irm.effective_settings import (
    EffectiveInformationRightsManagementSettings as EffectiveInformationRightsManagementSettings,
)
from office365.sharepoint.permissions.irm.file_settings import (
    InformationRightsManagementFileSettings as InformationRightsManagementFileSettings,
)
...
from office365.sharepoint.utilities.wopi_frame_action import (
    SPWOPIFrameAction as SPWOPIFrameAction,
)
from office365.sharepoint.webparts.limited_manager import (
    LimitedWebPartManager as LimitedWebPartManager,
)
...
class File(AbstractFile):
    ...
    def create_anonymous_link_with_expiration(
        self, expiration: datetime.datetime, is_edit_link: bool = False
    ) -> ClientResult[str]: ...
    def get_content(self) -> ClientResult[AnyStr]: ...
    def get_pre_authorized_access_url(
        self, expiration_hours: int
    ) -> ClientResult[str]: ...
    ...
    def get_image_preview_uri(
        self, width, height, client_type: Incomplete | None = None
    ): ...
    ...
    def copyto(
        self, destination: Folder | str, overwrite: bool = False, file_name: str = None
    ) -> File: ...
    def copyto_using_path(
        self, destination, overwrite: bool = False, file_name: Incomplete | None = None
    ): ...
    ...
    def download_session(
        self,
        file_object,
        chunk_downloaded: Incomplete | None = None,
        chunk_size=...,
        use_path: bool = True,
    ): ...
