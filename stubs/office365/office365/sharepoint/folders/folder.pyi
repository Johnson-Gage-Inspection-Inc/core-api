...
from office365.sharepoint.sharing.document_manager import (
    DocumentSharingManager as DocumentSharingManager,
)
...
from office365.sharepoint.storagemetrics.storage_metrics import (
    StorageMetrics as StorageMetrics,
)
from office365.sharepoint.types.resource_path import ResourcePath as SPResPath
from office365.sharepoint.utilities.move_copy_options import (
    MoveCopyOptions as MoveCopyOptions,
)
...
class Folder(Entity):
    ...
    def download_folder(
        self,
        download_file,
        after_file_downloaded: Incomplete | None = None,
        recursive: bool = True,
    ): ...
    ...
    def move_to_using_path_with_parameters(
        self, new_relative_path, retain_editor_and_modified: bool = False
    ): ...
    def share_link(
        self,
        link_kind: int,
    ...
    def update_document_sharing_info(
        ...
        validate_existing_permissions: Incomplete | None = None,
        additive_mode: Incomplete | None = None,
        send_server_managed_notification: Incomplete | None = None,
        custom_message: Incomplete | None = None,
        include_anonymous_links_in_notification: Incomplete | None = None,
        propagate_acl: Incomplete | None = None,
    ): ...
    def copy_to(
        self,
