...
class AutoQuotaEnabled(ClientValue):
    ...
    Value: Incomplete
    def __init__(
        self, is_read_only: Incomplete | None = None, value: Incomplete | None = None
    ) -> None: ...
    @property
    def entity_type_name(self): ...
...
class CreatePolicyRequest(ClientValue):
    ...
    def __init__(
        self,
        is_preview_run: Incomplete | None = None,
        policy_custom_name: Incomplete | None = None,
        policy_definition_details: Incomplete | None = None,
        policy_description: Incomplete | None = None,
        policy_frequency_unit: Incomplete | None = None,
        policy_frequency_value: Incomplete | None = None,
        policy_id: Incomplete | None = None,
        policy_tags: Incomplete | None = None,
        policy_template: Incomplete | None = None,
