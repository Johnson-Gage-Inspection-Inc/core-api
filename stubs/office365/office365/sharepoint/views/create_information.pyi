...
class ViewCreationInformation(ClientValue):
    ...
    def __init__(
        ...
        view_type_kind: Incomplete | None = None,
        view_fields: Incomplete | None = None,
        view_data: Incomplete | None = None,
        row_limit: Incomplete | None = None,
        query: Incomplete | None = None,
        personal_view: Incomplete | None = None,
        paged: Incomplete | None = None,
    ) -> None: ...
    @property
