...
class PermissionCollection(ClientValue):
    ...
    def __init__(
        self,
        app_consent_principals: Incomplete | None = None,
        has_inherited_links: Incomplete | None = None,
        links: Incomplete | None = None,
        principals: Incomplete | None = None,
        site_admins: Incomplete | None = None,
        total_number_of_principals: Incomplete | None = None,
    ) -> None: ...
    @property
