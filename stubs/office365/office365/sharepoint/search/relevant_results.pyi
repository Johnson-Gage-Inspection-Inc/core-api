...
class RelevantResults(ClientValue):
    ...
    def __init__(
        self,
        group_template_id: Incomplete | None = None,
        item_template_id: Incomplete | None = None,
        properties: Incomplete | None = None,
        result_title: Incomplete | None = None,
        result_title_url: Incomplete | None = None,
        table=...,
        row_count: Incomplete | None = None,
        total_rows: Incomplete | None = None,
        total_rows_including_duplicates: Incomplete | None = None,
    ) -> None: ...
