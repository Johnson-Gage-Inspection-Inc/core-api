...
class ListCreationInformation(ClientValue):
    ...
    def __init__(
        ...
        base_template: Incomplete | None = None,
        allow_content_types: bool = False,
        custom_schema_xml: Incomplete | None = None,
        document_template_type: Incomplete | None = None,
        quick_launch_option: Incomplete | None = None,
        template_feature_id: Incomplete | None = None,
        template_type: Incomplete | None = None,
    ) -> None: ...
    @property
