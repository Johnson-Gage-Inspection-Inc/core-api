...
class ResourceFacet(ClientValue):
    ...
    def __init__(
        self,
        content_type_id: Incomplete | None = None,
        file_system_object_type: Incomplete | None = None,
        file_type: Incomplete | None = None,
        item_id: Incomplete | None = None,
        item_unique_id: Incomplete | None = None,
        list_id: Incomplete | None = None,
        org_id: Incomplete | None = None,
        server_relative_path=...,
        site_id: Incomplete | None = None,
        title: Incomplete | None = None,
        web_id: Incomplete | None = None,
    ) -> None: ...
    @property
