...
class ChangeQuery(ClientValue):
    ...
    def __init__(
        ...
        role_assignment_add: bool = True,
        role_assignment_delete: bool = True,
        change_token_start: Incomplete | None = None,
        change_token_end: Incomplete | None = None,
        fetch_limit: Incomplete | None = None,
    ) -> None: ...
    @property
