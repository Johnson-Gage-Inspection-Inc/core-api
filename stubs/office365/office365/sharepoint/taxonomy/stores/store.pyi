...
from office365.sharepoint.taxonomy.groups.collection import (
    TermGroupCollection as TermGroupCollection,
)
...
class TermStore(TaxonomyItem):
    ...
    def search_term(
        self,
        label,
        set_id: Incomplete | None = None,
        parent_term_id: Incomplete | None = None,
