...
class MessageRuleActions(ClientValue):
    ...
    def __init__(
        self,
        assign_categories: Incomplete | None = None,
        copy_to_folder: Incomplete | None = None,
        delete: Incomplete | None = None,
        forward_as_attachment_to: Incomplete | None = None,
        forward_to: Incomplete | None = None,
        mark_as_read: Incomplete | None = None,
        mark_importance: Incomplete | None = None,
        move_to_folder: Incomplete | None = None,
        permanent_delete: Incomplete | None = None,
        redirect_to: Incomplete | None = None,
        stop_processing_rules: Incomplete | None = None,
    ) -> None: ...
