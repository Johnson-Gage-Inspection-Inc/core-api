...
from office365.search.sharepoint_onedrive_options import (
    SharePointOneDriveOptions as SharePointOneDriveOptions,
)
...
class SearchRequest(ClientValue):
    ...
    def __init__(
        self,
        query,
        aggregation_filters: Incomplete | None = None,
        aggregations: Incomplete | None = None,
        ...
        sort_properties: Incomplete | None = None,
        content_sources: Incomplete | None = None,
        sharepoint_onedrive_options=...,
    ) -> None: ...
