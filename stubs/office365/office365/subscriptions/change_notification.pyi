...
from office365.subscriptions.encrypted_content import (
    ChangeNotificationEncryptedContent as ChangeNotificationEncryptedContent,
)
...
class ChangeNotification(ClientValue):
    ...
    def __init__(
        self,
        change_type: Incomplete | None = None,
