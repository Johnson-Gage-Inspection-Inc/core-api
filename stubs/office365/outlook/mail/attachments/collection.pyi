...
from office365.runtime.odata.v4.upload_session_request import UploadSessionRequest as UploadSessionRequest
from office365.runtime.queries.upload_session import UploadSessionQuery as UploadSessionQuery

class AttachmentCollection(EntityCollection[Attachment]):
    def __init__(self, context, resource_path: Incomplete | None = None) -> None: ...
    def add_file(self, name, content: Incomplete | None = None, content_type: Incomplete | None = None, base64_content: Incomplete | None = None): ...
    def resumable_upload(self, source_path, chunk_size: int = 1000000, chunk_uploaded: Incomplete | None = None): ...
