...
from office365.outlook.mail.automatic_replies_mailtips import AutomaticRepliesMailTips as AutomaticRepliesMailTips
...
class MailTips(ClientValue):
    ...
    def __init__(self, automatic_replies=..., custom_mail_tip: Incomplete | None = None, delivery_restricted: Incomplete | None = None, email_address=..., error=..., external_member_count: Incomplete | None = None, is_moderated: Incomplete | None = None) -> None: ...
