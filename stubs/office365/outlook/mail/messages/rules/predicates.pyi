...
class MessageRulePredicates(ClientValue):
    ...
    def __init__(self, body_contains: Incomplete | None = None, body_or_subject_contains: Incomplete | None = None, categories: Incomplete | None = None, from_addresses: Incomplete | None = None, has_attachments: Incomplete | None = None, header_contains: Incomplete | None = None, importance: Incomplete | None = None, is_approval_request: Incomplete | None = None) -> None: ...
