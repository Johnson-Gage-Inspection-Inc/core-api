...
from office365.outlook.mail.attachments.collection import (
...
from office365.outlook.mail.messages.internet_header import (
    InternetMessageHeader as InternetMessageHeader,
)
...
class Message(OutlookItem):
    ...
    def upload_attachment(
        self, file_path, chunk_uploaded: Incomplete | None = None
    ): ...
    def send(self): ...
    ...
    def internet_message_headers(
        self,
    ) -> ClientValueCollection[InternetMessageHeader]: ...
    @property
