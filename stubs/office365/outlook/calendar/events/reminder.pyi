...
class Reminder(ClientValue):
    ...
    def __init__(self, change_key: Incomplete | None = None, event_end_time=..., event_id: Incomplete | None = None, event_location=..., event_start_time=..., event_subject: Incomplete | None = None, event_web_link: Incomplete | None = None, reminder_fire_time=...) -> None: ...
