...
from office365.booking.custom_question import BookingCustomQuestion as BookingCustomQuestion
...
from office365.booking.staff.availability_item import StaffAvailabilityItem as StaffAvailabilityItem
from office365.booking.staff.member_base import BookingStaffMemberBase as BookingStaffMemberBase
...
class BookingBusiness(Entity):
    def get_staff_availability(self, staff_ids: list[str] = None, start_datetime: datetime = None, end_datetime: datetime = None) -> ClientResult[ClientValueCollection[StaffAvailabilityItem]]: ...
    def publish(self): ...
    @property
    def address(self): ...
    @property
