...
from office365.sharepoint.authentication.acs_service_principal_info import SPACSServicePrincipalInfo as SPACSServicePrincipalInfo
from office365.sharepoint.businessdata.app_bdc_catalog import AppBdcCatalog as AppBdcCatalog
...
from office365.sharepoint.clientsidecomponent.hostedapps.manager import HostedAppsManager as HostedAppsManager
from office365.sharepoint.clientsidecomponent.identifier import SPClientSideComponentIdentifier as SPClientSideComponentIdentifier
...
from office365.sharepoint.clientsidecomponent.storage_entity import StorageEntity as StorageEntity
from office365.sharepoint.contenttypes.collection import ContentTypeCollection as ContentTypeCollection
from office365.sharepoint.entity_collection import EntityCollection as EntityCollection
from office365.sharepoint.eventreceivers.definition_collection import EventReceiverDefinitionCollection as EventReceiverDefinitionCollection
from office365.sharepoint.features.collection import FeatureCollection as FeatureCollection
from office365.sharepoint.fields.collection import FieldCollection as FieldCollection
from office365.sharepoint.fields.datetime_field_format_type import DateTimeFieldFormatType as DateTimeFieldFormatType
from office365.sharepoint.files.file import File as File
from office365.sharepoint.flows.synchronization_result import FlowSynchronizationResult as FlowSynchronizationResult
...
from office365.sharepoint.largeoperation.operation import SPLargeOperation as SPLargeOperation
...
from office365.sharepoint.lists.creation_information import ListCreationInformation as ListCreationInformation
from office365.sharepoint.lists.document_library_information import DocumentLibraryInformation as DocumentLibraryInformation
from office365.sharepoint.lists.get_parameters import GetListsParameters as GetListsParameters
from office365.sharepoint.lists.list import List as List
from office365.sharepoint.lists.render_data_parameters import RenderListDataParameters as RenderListDataParameters
from office365.sharepoint.lists.template_collection import ListTemplateCollection as ListTemplateCollection
from office365.sharepoint.lists.template_type import ListTemplateType as ListTemplateType
from office365.sharepoint.marketplace.corporatecuratedgallery.addins.principals_response import SPGetAddinPrincipalsResponse as SPGetAddinPrincipalsResponse
from office365.sharepoint.marketplace.corporatecuratedgallery.available_addins_response import SPAvailableAddinsResponse as SPAvailableAddinsResponse
from office365.sharepoint.marketplace.sitecollection.appcatalog.accessor import SiteCollectionCorporateCatalogAccessor as SiteCollectionCorporateCatalogAccessor
from office365.sharepoint.marketplace.tenant.appcatalog.accessor import TenantCorporateCatalogAccessor as TenantCorporateCatalogAccessor
...
from office365.sharepoint.permissions.securable_object import SecurableObject as SecurableObject
...
from office365.sharepoint.pushnotifications.collection import PushNotificationSubscriberCollection as PushNotificationSubscriberCollection
...
from office365.sharepoint.sharing.external_site_option import ExternalSharingSiteOption as ExternalSharingSiteOption
from office365.sharepoint.sharing.links.access_request import SharingLinkAccessRequest as SharingLinkAccessRequest
from office365.sharepoint.sharing.links.data import SharingLinkData as SharingLinkData
from office365.sharepoint.sharing.object_sharing_settings import ObjectSharingSettings as ObjectSharingSettings
from office365.sharepoint.sharing.result import SharingResult as SharingResult
from office365.sharepoint.sharing.shared_document_info import SharedDocumentInfo as SharedDocumentInfo
from office365.sharepoint.sitescripts.serialization_info import SiteScriptSerializationInfo as SiteScriptSerializationInfo
...
from office365.sharepoint.sitescripts.utility import SiteScriptUtility as SiteScriptUtility
...
from office365.sharepoint.ui.applicationpages.peoplepicker.web_service_interface import ClientPeoplePickerWebServiceInterface as ClientPeoplePickerWebServiceInterface
from office365.sharepoint.usercustomactions.collection import UserCustomActionCollection as UserCustomActionCollection
from office365.sharepoint.views.view import View as View
from office365.sharepoint.webparts.client.collection import ClientWebPartCollection as ClientWebPartCollection
from office365.sharepoint.webs.calendar_type import CalendarType as CalendarType
from office365.sharepoint.webs.context_web_information import ContextWebInformation as ContextWebInformation
from office365.sharepoint.webs.dataleakage_prevention_status_info import SPDataLeakagePreventionStatusInfo as SPDataLeakagePreventionStatusInfo
from office365.sharepoint.webs.information_collection import WebInformationCollection as WebInformationCollection
from office365.sharepoint.webs.modernize_homepage_result import ModernizeHomepageResult as ModernizeHomepageResult
from office365.sharepoint.webs.multilingual_settings import MultilingualSettings as MultilingualSettings
from office365.sharepoint.webs.regional_settings import RegionalSettings as RegionalSettings
from office365.sharepoint.webs.template_collection import WebTemplateCollection as WebTemplateCollection
...
class Web(SecurableObject):
    ...
    def get_adaptive_card_extensions(self, include_errors: Incomplete | None = None, project: Incomplete | None = None): ...
    def get_document_by_doc_id(self, doc_id): ...
    def get_site_script(self, include_branding: bool = True, included_lists: Incomplete | None = None, include_links_to_exported_items: bool = True, include_regional_settings: bool = True): ...
    ...
    def get_addin_principals_having_permissions_in_sites(self, server_relative_urls: Incomplete | None = None, urls: Incomplete | None = None): ...
    def get_app_bdc_catalog(self): ...
    def get_client_side_web_parts(self, project: Incomplete | None = None, include_errors: bool = False): ...
    ...
    def get_recycle_bin_items(self, paging_info: Incomplete | None = None, row_limit: int = 100, is_ascending: bool = True, order_by: Incomplete | None = None, item_state: Incomplete | None = None): ...
    def get_recycle_bin_items_by_query_info(self, is_ascending: bool = True, item_state: Incomplete | None = None, order_by: Incomplete | None = None, paging_info: Incomplete | None = None, row_limit: int = 100, show_only_my_items: bool = False): ...
    ...
    @staticmethod
    def create_anonymous_link(context, url, is_edit_link, return_type: Incomplete | None = None): ...
    @staticmethod
    def create_anonymous_link_with_expiration(context, url, is_edit_link, expiration_string, return_type: Incomplete | None = None): ...
    @staticmethod
    def get_object_sharing_settings(context, object_url, group_id: Incomplete | None = None, use_simplified_roles: Incomplete | None = None, return_type: Incomplete | None = None): ...
    def get_client_side_components_by_id(self, component_ids: Incomplete | None = None): ...
    ...
    def get_available_web_templates(self, lcid: int = 1033, do_include_cross_language: bool = False): ...
    ...
    def get_file_by_guest_url_extended(self, guest_url, ensure_access: Incomplete | None = None, password: Incomplete | None = None): ...
    ...
    def get_folder_by_guest_url_extended(self, guest_url, ensure_access: Incomplete | None = None, password: Incomplete | None = None): ...
    def parse_datetime(self, value: str, display_format: int = ..., calendar_type: int = ...) -> ClientResult[str]: ...
    def share(self, user_principal_name, share_option=..., send_email: bool = True, email_subject: Incomplete | None = None, email_body: Incomplete | None = None): ...
    def unshare(self): ...
    @staticmethod
    ...
    @staticmethod
    def get_sharing_link_kind(context, file_url, return_type: Incomplete | None = None): ...
    @staticmethod
    def forward_object_link(context, url, people_picker_input, email_subject: Incomplete | None = None, email_body: Incomplete | None = None): ...
    @staticmethod
    def share_object(context, url, people_picker_input, role_value: Incomplete | None = None, group_id: int = 0, propagate_acl: bool = False, send_email: bool = True, include_anonymous_link_in_email: bool = False, email_subject: Incomplete | None = None, email_body: Incomplete | None = None, use_simplified_roles: bool = True, return_type: Incomplete | None = None): ...
    @staticmethod
    ...
    def page_context_info(self, include_odb_settings: bool, emit_navigation_info: bool) -> ClientResult[AnyStr]: ...
    def get_storage_entity(self, key): ...
    def set_storage_entity(self, key, value, description: Incomplete | None = None, comments: Incomplete | None = None): ...
    ...
    def set_access_request_site_description_and_update(self, description: Incomplete | None = None): ...
