...
from office365.sharepoint.compliance.store_proxy import SPPolicyStoreProxy as SPPolicyStoreProxy
...
from office365.sharepoint.migration.job_status import SPMigrationJobStatus as SPMigrationJobStatus
from office365.sharepoint.portal.sites.icon_manager import SiteIconManager as SiteIconManager
...
from office365.sharepoint.sitehealth.summary import SiteHealthSummary as SiteHealthSummary
from office365.sharepoint.sites.azure_container_Info import ProvisionedTemporaryAzureContainerInfo as ProvisionedTemporaryAzureContainerInfo
from office365.sharepoint.sites.copy_job_progress import CopyJobProgress as CopyJobProgress
from office365.sharepoint.sites.home.site import SPHSite as SPHSite
from office365.sharepoint.sites.html_field_security_setting import HTMLFieldSecuritySetting as HTMLFieldSecuritySetting
...
from office365.sharepoint.sites.version_policy_manager import SiteVersionPolicyManager as SiteVersionPolicyManager
...
class Site(Entity):
    ...
    def create_migration_ingestion_job(self, g_web_id, azure_container_source_uri, azure_container_manifest_uri, azure_queue_report_uri, ingestion_task_key): ...
    def create_migration_job(self, g_web_id: Incomplete | None = None, azure_container_source_uri: Incomplete | None = None, azure_container_manifest_uri: Incomplete | None = None, azure_queue_report_uri: Incomplete | None = None): ...
    def create_preview_site(self, upgrade: Incomplete | None = None, sendemail: Incomplete | None = None): ...
    ...
    def get_recycle_bin_items(self, row_limit: int = 100, is_ascending: bool = True): ...
    ...
    def join_hub_site(self, hub_site_id, approval_token: Incomplete | None = None, approval_correlation_id: Incomplete | None = None): ...
    @staticmethod
    ...
    def run_health_check(self, rule_id: Incomplete | None = None, repair: Incomplete | None = None, run_always: Incomplete | None = None): ...
