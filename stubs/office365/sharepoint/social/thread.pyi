...
from office365.sharepoint.social.posts.reference import (
    SocialPostReference as SocialPostReference,
)
...
class SocialThread(ClientValue):
    ...
    def __init__(
        ...
        actors: Incomplete | None = None,
        replies: Incomplete | None = None,
        root_post=...,
        post_reference=...,
    ) -> None: ...
    @property
