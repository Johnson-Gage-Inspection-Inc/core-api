...
class SocialFeedManager(Entity):
    ...
    def create_post(self, target_id: Incomplete | None = None, creation_data: Incomplete | None = None): ...
    def delete_post(self, post_id): ...
    def create_file_attachment(self, name, description, file_data): ...
    def get_feed(self, feed_type: Incomplete | None = None, options: Incomplete | None = None): ...
    @property
    def owner(self): ...
    @property
