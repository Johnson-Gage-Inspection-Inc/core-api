...
class ClientPeoplePickerQueryParameters(ClientValue):
    ...
    def __init__(self, query_string, allow_emai_addresses: bool = True, allow_multiple_entities: bool = True, allow_only_email_addresses: bool = False, all_url_zones: bool = False, enabled_claim_providers: Incomplete | None = None, force_claims: bool = False, maximum_entity_suggestions: int = 1, principal_source=..., principal_type=..., url_zone: int = 0, url_zone_specified: bool = False, sharepoint_group_id: int = 0) -> None: ...
    @property
