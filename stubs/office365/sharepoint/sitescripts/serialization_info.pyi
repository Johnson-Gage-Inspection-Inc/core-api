...
class SiteScriptSerializationInfo(ClientValue):
    ...
    def __init__(
        self,
        include_branding: Incomplete | None = None,
        included_lists: Incomplete | None = None,
        include_links_to_exported_items: Incomplete | None = None,
        include_regional_settings: Incomplete | None = None,
        include_site_external_sharing_capability: Incomplete | None = None,
        include_theme: Incomplete | None = None,
    ) -> None: ...
    @property
