...
from office365.sharepoint.attachments.collection import AttachmentCollection as AttachmentCollection
...
from office365.sharepoint.comments.collection import CommentCollection as CommentCollection
...
from office365.sharepoint.fields.multi_lookup_value import FieldMultiLookupValue as FieldMultiLookupValue
from office365.sharepoint.fields.string_values import FieldStringValues as FieldStringValues
from office365.sharepoint.fields.url_value import FieldUrlValue as FieldUrlValue
from office365.sharepoint.likes.liked_by_information import LikedByInformation as LikedByInformation
from office365.sharepoint.listitems.compliance_info import ListItemComplianceInfo as ListItemComplianceInfo
from office365.sharepoint.listitems.form_update_value import ListItemFormUpdateValue as ListItemFormUpdateValue
from office365.sharepoint.listitems.update_parameters import ListItemUpdateParameters as ListItemUpdateParameters
from office365.sharepoint.listitems.versions.collection import ListItemVersionCollection as ListItemVersionCollection
...
from office365.sharepoint.sharing.links.share_request import ShareLinkRequest as ShareLinkRequest
from office365.sharepoint.sharing.links.share_response import ShareLinkResponse as ShareLinkResponse
from office365.sharepoint.sharing.links.share_settings import ShareLinkSettings as ShareLinkSettings
from office365.sharepoint.sharing.object_sharing_information import ObjectSharingInformation as ObjectSharingInformation
from office365.sharepoint.sharing.result import SharingResult as SharingResult
from office365.sharepoint.taxonomy.field_value import TaxonomyFieldValueCollection as TaxonomyFieldValueCollection
...
class ListItem(SecurableObject):
    def __init__(self, context, resource_path: Incomplete | None = None, parent_list: Incomplete | None = None) -> None: ...
    def archive(self): ...
    ...
    def validate_update_list_item(self, form_values, new_document_update: bool = False, checkin_comment: Incomplete | None = None, dates_in_utc: Incomplete | None = None): ...
    def update(self): ...
    def update_ex(self, bypass_quota_check: Incomplete | None = None, bypass_shared_lock: Incomplete | None = None): ...
