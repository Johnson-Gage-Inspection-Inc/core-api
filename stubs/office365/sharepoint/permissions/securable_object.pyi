...
from office365.sharepoint.permissions.roles.assignments.collection import RoleAssignmentCollection as RoleAssignmentCollection
...
class SecurableObject(Entity):
    ...
    def add_role_assignment(self, principal: Principal | str, role: RoleDefinition | int) -> Self: ...
    def remove_role_assignment(self, principal: Principal | str, role_def: RoleDefinition | int) -> Self: ...
    def break_role_inheritance(self, copy_role_assignments: bool = True, clear_sub_scopes: bool = True): ...
