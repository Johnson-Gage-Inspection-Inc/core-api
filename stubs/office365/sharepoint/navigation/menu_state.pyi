...
class MenuState(ClientValue):
    ...
    def __init__(self, audience_ids: Incomplete | None = None, friendly_url_prefix: Incomplete | None = None, nodes: Incomplete | None = None, simple_url: Incomplete | None = None, site_prefix: Incomplete | None = None) -> None: ...
