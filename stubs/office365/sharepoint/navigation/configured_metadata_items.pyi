...
class ConfiguredMetadataNavigationItem(ClientValue):
    ...
    def __init__(
        self,
        field_display_name: Incomplete | None = None,
        field_title: Incomplete | None = None,
        field_type_as_string: Incomplete | None = None,
        is_content_type_field: Incomplete | None = None,
        is_folder_hierarchy: Incomplete | None = None,
        is_hierarchy: Incomplete | None = None,
    ) -> None: ...
