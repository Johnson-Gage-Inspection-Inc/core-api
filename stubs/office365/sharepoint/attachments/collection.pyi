...
from office365.sharepoint.attachments.creation_information import AttachmentCreationInformation as AttachmentCreationInformation
...
class AttachmentCollection(EntityCollection[Attachment]):
    ...
    def add(self, attachment_file_information: AttachmentCreationInformation | dict) -> Attachment: ...
    def add_using_path(self, decoded_url: str, content_stream: AnyStr) -> Attachment: ...
    def delete_all(self): ...
    def download(self, download_file: IO, file_downloaded: Callable[[Attachment], None] | None = None) -> Self: ...
