...
class SearchResult(ClientValue):
    ...
    def __init__(self, elapsed_time: Incomplete | None = None, primary_query_result=..., properties: Incomplete | None = None, secondary_query_results: Incomplete | None = None, spelling_suggestion: Incomplete | None = None, triggered_rules: Incomplete | None = None) -> None: ...
