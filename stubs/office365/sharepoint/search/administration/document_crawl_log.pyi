...
class DocumentCrawlLog(Entity):
    ...
    def get_crawled_urls(self, get_count_only: bool = False, max_rows: Incomplete | None = None, query_string: Incomplete | None = None, content_source_id: Incomplete | None = None): ...
