...
from office365.sharepoint.userprofiles.hash_tag import HashTagCollection as HashTagCollection
from office365.sharepoint.userprofiles.person_properties import PersonProperties as PersonProperties
from office365.sharepoint.userprofiles.personal_site_creation_priority import PersonalSiteCreationPriority as PersonalSiteCreationPriority
...
class PeopleManager(Entity):
    ...
    def get_followers_for(self, account: str | User) -> EntityCollection[PersonProperties]: ...
    ...
    def get_user_profile_properties(self, user_or_name: str | User) -> ClientResult[dict]: ...
    def get_properties_for(self, account): ...
    def get_default_document_library(self, user_or_name, create_site_if_not_exists: bool = False, site_creation_priority=...): ...
