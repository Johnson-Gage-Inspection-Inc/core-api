...
from office365.sharepoint.fields.creation_information import FieldCreationInformation as FieldCreationInformation
...
from office365.sharepoint.fields.xmlSchemaFieldCreationInformation import XmlSchemaFieldCreationInformation as XmlSchemaFieldCreationInformation
...
class FieldCollection(EntityCollection[Field]):
    ...
    def add_datetime(self, title: str, description: str | None = None) -> FieldDateTime: ...
    def add_geolocation_field(self, title: str, description: str | None = None) -> FieldGeolocation: ...
    ...
    def add_lookup_field(self, title, lookup_list, lookup_field_name, allow_multiple_values: bool = False): ...
    ...
    def create_taxonomy_field(self, name, term_set, allow_multiple_values: bool = False): ...
    def create_field_as_xml(self, schema_xml, return_type: Incomplete | None = None): ...
