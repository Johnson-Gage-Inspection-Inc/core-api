...
from office365.sharepoint.changes.log_item_query import ChangeLogItemQuery as ChangeLogItemQuery
...
from office365.sharepoint.customactions.element_collection import CustomActionElementCollection as CustomActionElementCollection
...
from office365.sharepoint.fields.related_field_collection import RelatedFieldCollection as RelatedFieldCollection
from office365.sharepoint.files.checked_out_file_collection import CheckedOutFileCollection as CheckedOutFileCollection
...
from office365.sharepoint.listitems.creation_information import ListItemCreationInformation as ListItemCreationInformation
from office365.sharepoint.listitems.creation_information_using_path import ListItemCreationInformationUsingPath as ListItemCreationInformationUsingPath
from office365.sharepoint.listitems.form_update_value import ListItemFormUpdateValue as ListItemFormUpdateValue
...
from office365.sharepoint.pages.wiki_page_creation_information import WikiPageCreationInformation as WikiPageCreationInformation
...
from office365.sharepoint.webhooks.subscription_collection import SubscriptionCollection as SubscriptionCollection
from typing import AnyStr, Callable, IO
from typing_extensions import Self

class List(SecurableObject):
    def __init__(self, context, resource_path: Incomplete | None = None) -> None: ...
    def export(self, local_file: IO, include_content: bool = False, item_exported: Callable[[ListItem | File | Folder], None] = None) -> Self: ...
    def can_customize_forms(self): ...
    def clear(self): ...
    def create_document_and_get_edit_link(self, file_name: Incomplete | None = None, folder_path: Incomplete | None = None, document_template_type: int = 1, template_url: Incomplete | None = None): ...
    ...
    @staticmethod
    def get_list_data_as_stream(context, list_full_url, parameters: Incomplete | None = None, casc_del_warn_message: Incomplete | None = None, custom_action: Incomplete | None = None, drill_down: Incomplete | None = None, field: Incomplete | None = None, field_internal_name: Incomplete | None = None, return_type: Incomplete | None = None): ...
    @staticmethod
    def get_onedrive_list_data_as_stream(context, parameters: Incomplete | None = None, return_type: Incomplete | None = None): ...
    def bulk_validate_update_list_items(self, item_ids, form_values, new_document_update: bool = True, checkin_comment: Incomplete | None = None, folder_path: Incomplete | None = None): ...
    def get_lookup_field_choices(self, target_field_name, paging_info: Incomplete | None = None): ...
    def get_list_item_changes_since_token(self, query: ChangeLogItemQuery) -> ClientResult[AnyStr]: ...
    ...
    def add_item(self, creation_information: ListItemCreationInformation | dict) -> ListItem: ...
    def create_wiki_page(self, page_name, page_content): ...
    def add_item_using_path(self, leaf_name, object_type, folder_url): ...
    def add_validate_update_item(self, create_info, form_values: Incomplete | None = None): ...
    ...
    def render_list_data_as_stream(self, view_xml: Incomplete | None = None, render_options: Incomplete | None = None, expand_groups: Incomplete | None = None): ...
