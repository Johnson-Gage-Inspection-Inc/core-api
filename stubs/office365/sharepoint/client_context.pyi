from office365.runtime.auth.authentication_context import AuthenticationContext as AuthenticationContext
from office365.runtime.auth.client_credential import ClientCredential as ClientCredential
...
from office365.runtime.compat import get_absolute_url as get_absolute_url, urlparse as urlparse
...
from office365.runtime.odata.v3.batch_request import ODataBatchV3Request as ODataBatchV3Request
...
from office365.sharepoint.publishing.pages.service import SitePageService as SitePageService
...
from office365.sharepoint.request_user_context import RequestUserContext as RequestUserContext
...
class ClientContext(ClientRuntimeContext):
    def __init__(self, base_url: str, auth_context: AuthenticationContext | None = None, environment: str = None, allow_ntlm: bool = False, browser_mode: bool = False) -> None: ...
    @staticmethod
    def from_url(full_url: str) -> ClientContext: ...
    def with_client_certificate(self, tenant: str, client_id: str, thumbprint: str, cert_path: str | None = None, private_key: str | None = None, scopes: list[str] | None = None, passphrase: str | None = None) -> Self: ...
    ...
    def with_credentials(self, credentials: UserCredential | ClientCredential) -> Self: ...
    def execute_batch(self, items_per_batch: int = 100, success_callback: Callable[[list[ClientObject | ClientResult]], None] = None) -> Self: ...
    def pending_request(self): ...
    def execute_query_with_incremental_retry(self, max_retry: int = 5) -> None: ...
    def clone(self, url, clear_queries: bool = True): ...
    def create_modern_site(self, title: str, alias: str, owner: str | User | None = None) -> Site: ...
