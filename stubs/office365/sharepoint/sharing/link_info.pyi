...
class LinkInfo(ClientValue):
    ...
    def __init__(self, inherited_from=..., is_inherited: Incomplete | None = None, link_details=..., link_members: Incomplete | None = None, link_status: Incomplete | None = None, total_link_members_count: Incomplete | None = None) -> None: ...
