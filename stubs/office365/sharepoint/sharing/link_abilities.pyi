...
from office365.sharepoint.sharing.ability_status import (
    SharingAbilityStatus as SharingAbilityStatus,
)
...
class SharingLinkAbilities(ClientValue):
    ...
    def __init__(
        self,
        can_add_new_external_principals=...,
        can_delete_edit_link=...,
        can_delete_manage_list_link=...,
        can_get_edit_link=...,
        can_get_read_link=...,
    ) -> None: ...
    @property
