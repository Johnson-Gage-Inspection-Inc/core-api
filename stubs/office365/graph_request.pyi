...
from office365.runtime.auth.entra.authentication_context import AuthenticationContext as AuthenticationContext
...
class GraphRequest(ODataRequest):
    def __init__(self, version: str = 'v1.0', tenant: str = None, environment: str = ...) -> None: ...
    ...
    def with_token_interactive(self, client_id: str, username: str | None = None) -> GraphRequest: ...
