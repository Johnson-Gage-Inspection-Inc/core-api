...
from office365.teams.apps.user_scope_installation import UserScopeTeamsAppInstallation as UserScopeTeamsAppInstallation
...
class UserTeamwork(Entity):
    ...
    def send_activity_notification(self, topic, activity_type, chain_id, preview_text, template_parameters: Incomplete | None = None): ...
