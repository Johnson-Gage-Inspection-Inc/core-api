...
from office365.teams.channels.provision_email_result import ProvisionChannelEmailResult as ProvisionChannelEmailResult
...
class Channel(Entity):
    def does_user_have_access(self, user_id: str = None, tenant_id: str = None, user_principal_name: str = None) -> ClientResult[bool]: ...
